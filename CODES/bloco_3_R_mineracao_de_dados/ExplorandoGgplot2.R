...
install.packages("ggplot2") # Já instalado
library(ggplot2)
...
install.packages("gridExtra") # Já instalado
library(gridExtra)
library(ggplot2)
...
# Facets com reshape
install.packages("reshape2") # Já instalado
install.packages("plotly") # Já instalado
library(reshape2)
library(plotly)
