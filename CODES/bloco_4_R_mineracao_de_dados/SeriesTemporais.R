...
setwd("/{caminho/no/seu/computador}/bloco_4_R_meneracao_de_dados")
getwd()
...
install.packages("quantmod") # Já instalado
install.packages("xts") # Já instalado
install.packages("moments") # Já instalado
library(quantmod)
library(xts)
library(moments)
