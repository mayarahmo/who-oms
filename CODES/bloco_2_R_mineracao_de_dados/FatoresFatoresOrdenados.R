...
setwd("/{caminho/no/seu/computador}/bloco_2_R_meneracao_de_dados")
getwd()
...
grad <- c("Mestrado", "Doutorado", "Graduação", "Mestrado", "Mestrado")
grad
fac_grad <- factor(grad, order = TRUE, levels = c("Doutorado", "Mestrado", "Graduação"))
fac_grad
levels(fac_grad)
